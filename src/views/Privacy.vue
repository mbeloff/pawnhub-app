<template>
<div class="container mx-auto text-sm max-w-screen-lg py-20 ">
   <div class="px-3 mx-auto my-10 leading-7 text-justify text-zinc-300 font-light lg:text-left lg:px-20">
    <h1>Privacy Policy</h1>
    <p class="italic text-sm">Last updated: February 1, 2022</p>
    <p>
    ...
    <ul class="pl-6 list-disc list-outside">
      ...
      <li>
        ...
        this Agreement) refers to {{ common.company }}.
      </li>
      <li>
      ...
      <li>
        <strong>Website</strong> refers to pawnhub.com.au, accessible
        from
        <router-link :to="{ name: 'Home'}" class="text-blue-500 break-all hover:underline">https://www.pawnhub.com.au</router-link>
      </li>
      <li>
    ...
    <ul class="pl-6 list-disc list-outside">
      <li class="break-all">
        By email: {{ common.email }}
      </li>
      <li class="">
        By post: <span v-for="item in common.address">{{ item + ' ' }} </span>
